...
function vsGMTPToPlayer()
{
	%player = VSGMGuiTPPlayerName.GetValue();
	...
	// Disable cursor
	VSGMGuiTPPlayerName.setActive(false); VSGMGuiTPPlayerName.setActive(true);

	// SAVE PREFS
	$pref::VSGMTools::TPPlayerName = %player;
